...
const NIKE_CATALOG = [
  ...
  { name: "Nike Zoom Fly 6", price: 165, styles: ["athletic","editorial"], features: "Carbon fiber plate, React foam, built for race-day speed and energy return.", wearWith: "Racing kits or sleek performance tights.", whereTo: "Race days, tempo runs, training sessions, fitness events.", nikeUrl: "https://www.nike.com/w?q=zoom+fly+6&vst=zoom+fly+6" },
  ...
  { name: "Nike Blazer Mid '77", price: 100, styles: ["retro","editorial","lifestyle"], features: "High-foam midsole, vintage-finish overlays, classic court silhouette.", wearWith: "Pleated trousers, a blazer, wide-leg jeans, or a slip dress.", whereTo: "Gallery nights, work-casual days, coffee dates, shopping trips.", nikeUrl: "https://www.nike.com/w?q=blazer+mid+77&vst=blazer+mid+77" },
  { name: "Nike Free Metcon 7", price: 130, styles: ["athletic","lifestyle"], features: "Flexible forefoot, stable heel, built for gym training and cross-training.", wearWith: "Training shorts, gym leggings, or a fitted tank set.", whereTo: "Weight training, HIIT classes, CrossFit, gym sessions.", nikeUrl: "https://www.nike.com/w?q=free+metcon+7&vst=free+metcon+7" },
  { name: "Nike Free Metcon 10", price: 140, styles: ["athletic","lifestyle"], features: "Updated Metcon with improved flexibility, wider base and training grip.", wearWith: "Training shorts, gym leggings, or a performance tank set.", whereTo: "Lifting, functional fitness, gym classes, studio workouts.", nikeUrl: "https://www.nike.com/w?q=free+metcon+10&vst=free+metcon+10" },
];
